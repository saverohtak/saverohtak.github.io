<?php include("header.php");?>
    ...
    <div class="row fullWidth container">
        <div class="columns small-12 medium-8"  id="letter">
            <section class="video">
                <iframe width="100%" height="360" src="https://www.youtube.com/embed/mJOpP3gZd8U?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>
            </section>
            <section>
                <div class="row columns small-12 medium-12 letter">
                    <h2>Letter To C.M., Haryana</h2>

                    <div>
                        <p>To</p>

                        <p>Sh. Manohar Lal Khattar<br>Chief Minister of Haryana</p>
                        <p>Respected Sir</p>
                        ...
                        <p>I Request you on behalf of people of Haryana, to solve this matter as soon as possible, So that we can live peacefully.
                        </p>
